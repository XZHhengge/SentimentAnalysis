...
#                                               'data/A/Neg-train.txt')  # pos neg
# print("In test data:")
# testData, testSteps, testLabels = makeData('data/A/Pos-test.txt',
#                                            'data/A/Neg-test.txt')  # pos neg
# # B数据
# print("In train data:")
# trainData, trainSteps, trainLabels = makeData('data/B/Pos-train.txt',
#                                               'data/B/Neg-train.txt')  # pos neg
# print("In test data:")
# testData, testSteps, testLabels = makeData('data/B/Pos-test.txt',
#                                            'data/B/Neg-test.txt')   # pos neg
#
# C数据
print("In train data:")
trainData, trainSteps, trainLabels = makeData('data/C/pos.txt',
                                              'data/C/neg.txt')  # pos neg
print("In test data:")
testData, testSteps, testLabels = makeData('data/C/test-pos.txt',
                                           'data/C/test-neg.txt')   # pos neg
